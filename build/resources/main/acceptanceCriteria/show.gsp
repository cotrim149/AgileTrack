...
<html>
    ...
    <body>
        ...
        <div id="show-acceptanceCriteria" class="content scaffold-show" role="main">
            ...
            <f:display bean="acceptanceCriteria" />
            <g:form resource="${this.acceptanceCriteria}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.acceptanceCriteria}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
